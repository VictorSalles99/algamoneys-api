...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
	...
	public Page<Lancamento> filtrar(LancamentoFilter lancamentoFilter, Pageable page) {
		...
		adicionarRestricoesDePaginacaoNaQuery(query, page);
	...
	private void adicionarRestricoesDePaginacaoNaQuery(TypedQuery<Lancamento> query, Pageable page) {
		int pagAtual = page.getPageNumber();
		int regsPorPagina = page.getPageSize();
		int primerioRegistro = pagAtual * regsPorPagina;
